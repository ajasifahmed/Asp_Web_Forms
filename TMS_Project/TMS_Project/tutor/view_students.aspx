...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="jumbotron bg-dark text-center text-white">View Students Details</h1>
        </div>
    </div>
        <div class="row">
        <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card bg-secondary text-center text-white ">
                        ...
                        <div class="card-body">
                            ...
                            <small class=" font-weight-bold">Tutor Required</small>
                            <h5>
                                <asp:Label ID="Label3" runat="server" Text='<%#Bind("tutor_type") %>'></asp:Label></h5>
                            ...
                            <small class=" font-weight-bold">Tution Type</small>
                            <h5>
                                <asp:Label ID="Label6" runat="server" Text='<%#Bind("tution_type") %>'></asp:Label></h5>
                        </div>
                        <div class="card-footer bg-dark">
                                                        <small class=" font-weight-bold">For Subject</small>
                            <h4><asp:Label ID="Label7" runat="server" Text='<%#Bind("subject") %>'></asp:Label></h4>
                             <small class=" font-weight-bold">Class</small>
                            <h4><asp:Label ID="Label9" runat="server" Text='<%#Bind("class") %>'></asp:Label></h4>
                            <small class=" font-weight-bold">Address</small>
                            <h4><asp:Label ID="Label8" runat="server" Text='<%#Bind("address") %>'></asp:Label></h4>
                        </div>
                    </div>
                    <br />
                </div>
