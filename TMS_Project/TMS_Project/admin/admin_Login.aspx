        ...
        <div class="container">
            <div class="row">
                <div class="signup-form mt-5">
                    <h2 class="text-info text-center">Welcome Admin!</h2>
                    <p>Please enter your email address and password to login to your account!</p>
                    <hr />

                    <div class="form-group">
                        <asp:TextBox ID="UserEmailTextBox" class="S-form-control form-control" placeholder="Email*" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="UserEmailTextBox" Display="Dynamic" SetFocusOnError="true" ForeColor="Red" runat="server" ErrorMessage="Email is required"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ErrorMessage="Invalid Email" ControlToValidate="UserEmailTextBox" Display="Dynamic" SetFocusOnError="true" ForeColor="Red" runat="server" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button CssClass="btn btn-info btn-block" ID="LoginButton" runat="server" Text="Login" OnClick="LoginButton_Click" />
